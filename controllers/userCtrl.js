...
const userCtrl = {
    ...
    register: async (req, res) => {
        try {
            ...
            res.json({msg: "Register Success! Please activate your email to start. Please review you spam or junk folder, maybe the confirmation email arrived there. Thank you!"})
